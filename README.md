...
1. 모든 독자의 글 소비 패턴을 활용하여 지정한 테스트 독자가 소비할 글을 추론하는 방법과
2 독자의 작가에 대한 선호도와 독자의 성향과 작가의 성향간의 유사도를 계산하여 테스트 독자가 소비할 글을 추론하는 방법을 


### 2.1 Collaborative Approach
### 2.2 Content Based Approach
### 2.3 Personalized Approach
### 2.1. Doc2Vec 모델
Doc2Vec은 (읽은 글들로 추정되는) 독자와 (작성한 글들로 추정되는) 작가간의 유사도를 추천에 반영하기 위해 필요한 모델입니다. 결론적으로는 독자와 작가들을 벡터 공간에 embedding하고 그 거리를 측정하여 추천에 반영합니다.
